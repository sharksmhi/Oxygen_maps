...
print(ds)
ds.to_netcdf('resultat/nc/modified_test.nc') # rewrite to netcdf
...
axs[0, 0].set_title(f'minimum depths where oxygen <={hypox} ml/l')
...
axs[0, 1].set_title(f'minimum depths where oxygen <={anox} ml/l')
...
# Save the plot
plt.savefig(f'resultat/figures/_hypox.png')
