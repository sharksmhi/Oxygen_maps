...
for season in ['Winter', 'Spring', 'Summer', 'Autumn']:
    print(f'open netcdf for {season}')
    #netcdf_filename = f"Oxygen_1960-2021_{season}_1_49000.0_0.05_5.0_2.0_with_backgroundfield_moredepths_gebco_30sec_4"
    netcdf_filename = f"Oxygen_1960-2021_{season}_1_49000.0_0.05_5.0_2.0_with_backgroundfield_moredepths_gebco_30sec_4"
    ds = xr.open_dataset(f'{location}/resultat/nc/processed/Oxygen_1960-2021_{season}_1_49000.0_0.05_5.0_2.0_with_backgroundfield_moredepths_gebco_30sec_4.nc')
    ...
    observation_span = 2
    for show_year in range(2009,2010):
        # Select a time index from show_year and depth level from show_depth
        ...
        # Save the plot
        plt.savefig(f'{location}/resultat/figures/maps_{year_month}_{show_depth}_{netcdf_filename}.png', dpi = 300, transparent=True)
